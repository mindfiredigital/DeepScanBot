...
# Run a quick scan
deepscanbot scan https://example.com depth=2 json=true
```

No Go installation required. The npm package automatically installs the correct pre-built binary for your platform.
...
go run ./apps/cli scan https://example.com depth=2 json=true
